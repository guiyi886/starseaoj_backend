...
**星海 OJ 在线判题系统——部署上线网址**     	**~~http://139.159.248.204~~**   **http://124.223.140.226/**
...
代码沙箱实现了两种（均为Java沙箱），一种是本地代码沙箱，一种是**Docker代码沙箱**。

最终上线采用的是第二种，因为Docker的封闭性可以更好的保证系统的安全性和可靠性。
